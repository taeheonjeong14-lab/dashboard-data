...
import { CATEGORY_BADGE_BG, CATEGORY_WORD, STAGE_WORD, STAGE_COLOR, type BadgeCategory } from '@/lib/case-status';

type StageKey = 'requested' | 'writing' | 'done';

// 차트 목록·상세·진료케이스 메뉴 공용 상태 배지.
// 배경 = 카테고리(블로그 노랑 / 검진리포트 파랑), 단계 '단어'에만 색(요청 빨강/작성중 주황/완료 파랑).
