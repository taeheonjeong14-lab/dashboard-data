              ...
              items.map((n) => {
                ...
                return (
                  <button key={n.id} type="button" onClick={() => void onClick(n)}
                    style={{ display: 'flex', gap: 9, width: '100%', textAlign: 'left', padding: '11px 14px', border: 'none', borderBottom: '1px solid var(--border)', background: n.read ? 'transparent' : 'var(--accent-subtle)', cursor: 'pointer' }}>
