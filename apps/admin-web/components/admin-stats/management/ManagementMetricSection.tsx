    ...
    <section className="border-b border-slate-200 bg-white p-4 sm:p-5 last:border-b-0">
      ...
      {!hasData ? (
        ...
        <div className="flex flex-col gap-8">
          <div>
            <h3 className="mb-2 text-sm font-medium text-slate-700">{title} 추이</h3>
                      ...
                      return (
                        <div className="rounded border border-slate-300 bg-white px-2.5 py-1.5 text-xs shadow-lg">
                          ...
                          <p className="text-slate-900">
                            값 <span className="text-slate-700">{text}</span>
                          </p>
                        </div>
                      );
                    }}
          ...
          <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
                  ...
                  <BarChart data={yoyRows} margin={{ top: 8, right: 12, bottom: 8, left: 4 }}>
                    ...
                    <Tooltip
                      ...
                      content={({ payload }) => {
                        ...
                        return (
                          <div className="rounded border border-slate-300 bg-white px-2.5 py-1.5 text-xs shadow-lg">
                            <p className="mb-1 text-slate-700">{formatMonthOnly(ym)}</p>
                            <p className="text-slate-900">
            ...
            <div>
              <h3 className="mb-2 text-sm font-medium text-slate-700">요일별 {title} 분석</h3>
              <div className="h-[320px] w-full min-w-0">
                <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={200}>
                  <BarChart data={weekdayRows} margin={{ top: 8, right: 12, bottom: 8, left: 4 }}>
                    ...
                    <Tooltip
                      ...
                      content={({ payload }) => {
                        ...
                        return (
                          <div className="rounded border border-slate-300 bg-white px-2.5 py-1.5 text-xs shadow-lg">
                            <p className="mb-1 text-slate-700">{row?.weekdayLabel ?? ""}</p>
                            <p className="text-slate-800">
                              최근 12개월 {row?.weekdayLabel ?? "해당 요일"} 평균: {avgText}
                            </p>
                            <p className="text-slate-900">{recentText}: {last7Text}</p>
                          </div>
                        );
                      }}
                    />
