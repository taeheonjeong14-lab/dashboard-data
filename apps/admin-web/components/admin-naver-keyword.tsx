  ...
  return (
    <div style={{ maxWidth: 980, margin: '0 auto' }}>
      ...
      {data && (data.rows?.length ?? 0) > 0 ? (
        ...
        <div style={{ padding: 24, textAlign: 'center', fontSize: 13, color: 'var(--text-muted)' }}>조회 결과가 없습니다.</div>
      ) : null}
    </div>
  );
}
