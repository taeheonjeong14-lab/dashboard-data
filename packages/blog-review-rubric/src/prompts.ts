...
# 각 finding 작성법 (★중요)
- quote: 문제 부분을 원문 그대로 짧게 인용. 인용할 문장이 없는 부재형 지적은 위치만 적거나 생략.
- issue: 무엇이 왜 문제인지 한 문장.
- suggestion: 어떻게 고칠지 구체적으로(가능하면 대체 문구).
- evidence: (내부) 원본의 실제 값·근거("원본 ALT 250"). (외부) 원본 대조가 필요한 지적은 "출처 대조 불가", 그 외는 지식 근거.
...
- quote 는 원문 인용을 유지(가장 정확히 인용한 것). issue·suggestion 은 셋을 종합해 가장 명료하게.
