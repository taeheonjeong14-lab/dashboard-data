-- pgcrypto digest() is digest(bytea, text). Untyped 'sha256' yields digest(text, unknown) and fails (42883).
-- Use UTF-8 bytes + explicit algorithm type.
-- Include schema `extensions` (Supabase default for pgcrypto) so digest() resolves.
