...
// 주제별 그룹 헤더 + 불릿으로 아주 간결하게(수치·명사구 위주).
const SUMMARY_PROMPT = [
  '아래는 동물병원 진료케이스의 참고용 외부 자료(외부 검사 결과서 등)에서 추출한 원문 텍스트입니다.',
  '진료케이스 글 작성에 쓸 수 있도록 아주 간결하게 요약하세요.',
  '',
  '형식: 내용을 주제(검사·항목)별로 묶어, 주제 헤더 한 줄 아래에 불릿("- ")으로 정리한다.',
  '예)',
  '혈액검사:',
  '- SDMA 18 µg/dL (↑ 정상 0–14)',
  '- BUN 42 mg/dL (↑)',
  '복부 초음파:',
  '- 담낭벽 비후, 슬러지',
  '',
  '규칙:',
  '(1) 검사명·수치·단위·정상범위·비정상 소견·판독 결론·검사일 등 임상적으로 의미 있는 데이터만.',
  '(2) 각 불릿은 한 줄, 수치·명사구 위주로 짧게(완결 문장·서술 금지).',
  '(3) 병원명·환자 인적사항·페이지번호·서식 문구 등 불필요한 내용 제외.',
  '(4) 원문에 있는 것만, 없는 내용 창작 금지. 한국어.',
  '요약만 출력(머리말·설명 없이). 의미 있는 내용이 없으면 빈 문자열로 답하세요.',
].join('\n');
