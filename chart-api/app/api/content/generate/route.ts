...
- 구조:
  · types: 그날 성격 배열 — exam_dx(검사 및 진단: 질환 판단 검사 있던 날)/preop(술 전 검사: 수술 케이스에서 마취 가능 판단 검사한 날)/surgical(외과: 수술한 날)/medical(내과: 약 처방해 내과 치료한 날)/admission(입원 치료 받은 날)/discharge(입원 케이스에서 퇴원한 날) 중 해당하는 것 여러 개 가능(없으면 []).
