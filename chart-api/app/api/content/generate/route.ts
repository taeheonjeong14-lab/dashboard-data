...
- medical(내과 치료): **치료 + 경과 확인 통합 섹션**. detail(약 종류)을 성분·약효 분류 수준으로 facts 에. 치료 기간의 주요 수치 변화(OO→OO)·용량 조절로 호전 과정을 시점 순으로(상태가 좋아지는 과정을 보여주는 게 핵심). 내과는 회복·경과 확인이 이 섹션에 다 녹으므로 별도 recovery 섹션을 만들지 않는다.
